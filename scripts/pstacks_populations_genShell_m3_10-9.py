...
newfile = open("cstacks_populations_batch3_10-9.sh", "w")
...
filestring = "cstacks -b 3 "
for line in catFile: 			#for each sample file listed in the cstacks catalog file
	sampID = line.strip()	
	if sampID.startswith("#"): 
		newstring = ""
	else: 		
		newstring = "-s ../stacks_b3_wgenome/" + sampID + " "
	filestring += newstring
catFile.close()
filestring += "-o ../stacks_b3_wgenome -g -p 6 2>> ../stacks_b3_wgenome/cstacks_out_b3_wgenome"
...
for line in korsamples: 			#for each line in the barcode file
	...
	newstring = "sstacks -b 3 -c ../stacks_b3_wgenome/batch_3 -s ../stacks_b3_wgenome/" + linelist[0] + " -o ../stacks_b3_wgenome -p 6 2>> ../stacks_b3_wgenome/sstacks_out_b3_wgenome"	#creates a new -s entry for that sample input file
...
##populations
newfile.write("populations -b 3 -P ../stacks_b3_wgenome -M PopMap_combo_b3.txt -t 36 -r 0.5 -p 3 -m 10 --genepop --fasta 2>> ../stacks_b3_wgenome/populations_out_b3_wgenome")
