...
genepop = open(stacksDIRECT + "/batch_" + BATCH + ".CorrectedGenotypes_biallelic_genepop.txt", "r") 
new_genepop = open(stacksDIRECT + "/batch_" + BATCH + ".CorrectedGenotypes_biallelic_genepop_edit.txt", "w") 
