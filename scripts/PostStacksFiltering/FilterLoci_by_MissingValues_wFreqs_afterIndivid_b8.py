...
for mystring in tempfile:		# Read in each line in the file as a string
	if count == 0:
		...
		JinhaeBay07 = stripped_string.split(' ')[158:205]
		JinhaeBay08 = stripped_string.split(' ')[205:256]
		Boryeong07 = stripped_string.split(' ')[256:280]
		Geoje14 = stripped_string.split(' ')[280:315]
		Kodiak03 = stripped_string.split(' ')[315:358]
		Adak06 = stripped_string.split(' ')[358:391]
		WashCoast05 = stripped_string.split(' ')[391:430]
		HecStrait04 = stripped_string.split(' ')[430:473]
		SalishSea12_13 = stripped_string.split(' ')[473:494]
		SalishSea12_13.append(stripped_string.split(' ')[515:528])
		JuandeFuca12 = stripped_string.split(' ')[494:515]
		PWSound12 = stripped_string.split(' ')[528:575]
		UnimakPass03 = stripped_string.split(' ')[575:619]
