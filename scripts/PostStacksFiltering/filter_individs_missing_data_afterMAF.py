...
parser = argparse.ArgumentParser(description="filter individuals for missing data. assumes input file has individuals as column headers, separated by comma")
