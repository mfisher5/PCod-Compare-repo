...
# transpose the matrix so that columns are individuals, rows are loci. 
...
tempfile = open("temp_transposed_genotypes.txt", "r")

count = 0
bad_count = 0

for mystring in tempfile:		# Read in each line in the file as a string
	if count == 0:
		...
		Jukbyeon07 = stripped_string.split(' ')[121:157]
		JinhaeBay07 = stripped_string.split(' ')[157:196]
		JinhaeBay08 = stripped_string.split(' ')[196:239]
		Boryeong07 = stripped_string.split(' ')[239:263]
		Geoje14 = stripped_string.split(' ')[263:298]
		Kodiak03 = stripped_string.split(' ')[298:331]
		Adak06 = stripped_string.split(' ')[331:358]
		WashCoast05 = stripped_string.split(' ')[358:388]
		HecStrait04 = stripped_string.split(' ')[388:424]
		SalishSea12_13 = stripped_string.split(' ')[424:441]
		SalishSea12_13.append(stripped_string.split(' ')[459:470])
		JuandeFuca12 = stripped_string.split(' ')[441:459]
		PWSound12 = stripped_string.split(' ')[470:514]
		UnimakPass03 = stripped_string.split(' ')[514:551]
...
tempfile.close()
os.remove("temp_transposed_genotypes.txt")