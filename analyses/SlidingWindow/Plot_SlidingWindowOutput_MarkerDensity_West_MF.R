...
swa_input = read.table("West/batch_8_SWA_input_west_sorted.txt", header = TRUE, sep = "\t")
head(swa_input)
...
find_markers_in_window(marker_data = swa_input, window_size= 250000, divisions = 150, output = "West_Num_Name_Loci_Per_Window.txt")
...
##-- plot
just_plot_md(data = swa_output, marker_density = marker_data, Nb_bootstrap=100000, which.chromosome.analysis="all", which.chromosome.plot="all",export = TRUE, name="plots/West/batch_8_west_SWA_filtered")
