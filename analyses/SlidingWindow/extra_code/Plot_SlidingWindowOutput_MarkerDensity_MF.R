...
#
# MF edited for Pacific cod 2/16/2018
#
#########################################################################
...
marker_data = read.table("batch_8_MB_SLA_input_sorted.txt", header = TRUE, sep = "\t")
View(marker_data)
...
qplot(markers_per_window, geom="histogram",
      binwidth = 1,
      main = "Markers per Sliding Window\nAcross all Chromosomes",
      xlab = "# Markers", 
      ylab = "# Windows")
...
##-- do you need to subset marker density data?
...
##-- if so, subset according to # divisions per chromosome
