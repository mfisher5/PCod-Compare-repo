...
llrange=[120,135,30,40]  #example: [120,135,30,40] captures the Korean Peninsula area
...
m.contourf(x,y,data['PRESSURE'][plevel,ll_index[2]:ll_index[3],ll_index[0]:ll_index[1]],10,latlon='True')
plt.colorbar()
plt.show()
