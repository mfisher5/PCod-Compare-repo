...
compare_KOR_genos_Depths3v10 <- read_delim("compare_KOR_genos_Depths3v10.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
...
#plot
boxplot(p_combined, col="darkcyan", names = c("Genotyped in Original", "Genotyped in Subset"), ylab = "Proportion of Shared Loci", main = "Loci that were Genotyped in Original v. Subset Korean data")
...
#plot
boxplot(p_diff_missing_combined, col="darkcyan", names = c("Original Genotype Missing", "Subset Genotype Missing"), ylab = "Proportion of Shared Loci that Did Not Match in Individual", main = "Differing Genotypes at Locus\n From Missing Data")
...
#plot
boxplot(p_diff_combined, col="darkcyan", names = c("Total Mismatched\n", "\nHeterozygote \nto Homozygote", "\nHomozygote \nto Heterozygote"), ylab = "Proportion of Shared Loci Genotyped in both Samples", main = "Cause of Differing Genotypes at Locus\n When both Original & Subset Samples Genotyped")
